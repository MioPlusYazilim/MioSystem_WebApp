    ...
    public partial class FrmMainList : FrmBaseUserControl
    {
        ...
        private void FrmMainList_Load(object sender, EventArgs e)
        {
            ...
            if (!string.IsNullOrEmpty(formSettings.FormPermissions.listSourceName))
            {
                ...
                using (DxFunctions dxf = new DxFunctions())
                    dxf.SetGrid(gridViewMainList, false);
            }
        ...
        {
            var nFormSettings = formSettings;
            nFormSettings.FormID = ID;
            FormFactory.CreateOrActivateEditForm(AppDocumentManager, nFormSettings);
        }
