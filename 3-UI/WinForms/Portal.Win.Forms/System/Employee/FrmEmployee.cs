...
namespace Portal.Win.Forms
{
    public partial class FrmEmployee : FrmBaseFormEdit
    {
        ...
        {
            object[] colFields ={new CustomDataObject("ID","id"),
                                new CustomDataObject("Personel Ünvani","fullName"),
                                new CustomDataObject("Email","email"),
                                new CustomDataObject("GSM","gSMNumber")};
            _cols = colFields;
            return employeeService.EmployeeMainList();
        }
