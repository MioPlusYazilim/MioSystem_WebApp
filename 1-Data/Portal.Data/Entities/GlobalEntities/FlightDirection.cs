...
{
    public class FlightDirection : BaseEntity
    {
    ...
    /*EntityMap Oluştur*/
    public class FlightDirection_Configuration : IEntityTypeConfiguration<FlightDirection>
    {
        public void Configure(EntityTypeBuilder<FlightDirection> builder)
        {
            // Primary Key
            ...
            builder.Property(t => t.GroupValue).HasColumnName("GroupValue");

            builder.Ignore(i => i.Deleted);
            builder.ToTable("FlightDirection");
            // Navigate Properties
        }
    }
}
