...
{
    public class EmployeeAuthorization : BaseEntity
    {
    ...
    /*EntityMap Oluştur*/
    public class EmployeeAuthorization_Configuration : IEntityTypeConfiguration<EmployeeAuthorization>
    {
        public void Configure(EntityTypeBuilder<EmployeeAuthorization> builder)
        {
            // Primary Key
            ...
            builder.ToTable("EmployeeAuthorization");
            // Navigate Properties
        }
    }
}
